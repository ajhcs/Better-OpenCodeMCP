...
<div class="funding-card">
  ...
  <ul>
    ...
    <li><strong>API Testing Credits:</strong> Funds are used for testing various deployements of opencode-mcp-tool on popular clients.</li>
  </ul>
...
<div class="support-options" style="margin: 32px auto; max-width: 600px;">
  <a href="https://github.com/sponsors/frap129" target="_blank" rel="noopener" class="support-button support-button--primary">
